 ...
 */
namespace Fahim\SiteMap\Helper;

use Magento\Framework\App\Helper\Context;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const MAX_PRODUCTS = 'Fahim_sitemap/product/max_products';
    const SORT_PRODUCT = 'Fahim_sitemap/product/sort_product';
    const ORDER_PRODUCT = 'Fahim_sitemap/product/order_product';
    ...
    {
        $additionUrl = $this->scopeConfig->getValue('Fahim_sitemap/addition/addition_link', $this->scopeStore);
    ...
    {
        $cmsLink = $this->scopeConfig->getValue('Fahim_sitemap/cms/do_something', $this->scopeStore);
    ...
    {
        $isEnable = $this->scopeConfig->isSetFlag('Fahim_sitemap/general/enable', $this->scopeStore);
        return $isEnable;
    }
    ...
    {
        if ($storeId) {
            $value = $this->scopeConfig->getValue('Fahim_sitemap/general/router', $this->scopeStore, $storeId);
        } else {
            $value = $this->scopeConfig->getValue('Fahim_sitemap/general/router', $this->scopeStore);
        }
        if (!$value) {
    ...
    {
        return $this->scopeConfig->getValue(
            "Fahim_sitemap/for_search/description",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            "Fahim_sitemap/for_search/keywords",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            "Fahim_sitemap/for_search/meta_title",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        if ($storeId !== null) {
            $categoryDisable = $this->scopeConfig->getValue('Fahim_sitemap/category/id_category', $this->scopeStore, $storeId);
        } else {
            $categoryDisable = $this->scopeConfig->getValue('Fahim_sitemap/category/id_category', $this->scopeStore);
        }
    ...
    {
        $enableCategory = $this->scopeConfig->isSetFlag('Fahim_sitemap/category/enable_category', $this->scopeStore);
    ...
    {
        $enableProduct = $this->scopeConfig->isSetFlag('Fahim_sitemap/product/enable_product', $this->scopeStore);
    ...
    {
        $enableCms = $this->scopeConfig->isSetFlag('Fahim_sitemap/cms/enable_cms', $this->scopeStore);
        return $enableCms;
    }
    ...
    {
        $enableStoreView = $this->scopeConfig->isSetFlag('Fahim_sitemap/store/enable_store', $this->scopeStore);
    ...
    {
        $orderTemplates = $this->scopeConfig->getValue('Fahim_sitemap/general/order_templates', $this->scopeStore);
    ...
    {
        $titleCategory = $this->scopeConfig->getValue('Fahim_sitemap/category/title_category', $this->scopeStore);
    ...
    {
        $showLinkAt = $this->scopeConfig->getValue('Fahim_sitemap/general/show_link', $this->scopeStore);
    ...
    {
        $titleCms = $this->scopeConfig->getValue('Fahim_sitemap/cms/title_cms', $this->scopeStore);
    ...
    {
        $titleProduct = $this->scopeConfig->getValue('Fahim_sitemap/product/title_product', $this->scopeStore);
    ...
    {
        $titleStore = $this->scopeConfig->getValue('Fahim_sitemap/store/title_store', $this->scopeStore);
    ...
    {
        $titleAddition = $this->scopeConfig->getValue('Fahim_sitemap/addition/title_addition', $this->scopeStore);
    ...
    {
        $openNewTab = $this->scopeConfig->getValue('Fahim_sitemap/addition/open_new_tab', $this->scopeStore);
